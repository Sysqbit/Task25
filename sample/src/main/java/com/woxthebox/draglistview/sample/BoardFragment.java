...
public class BoardFragment extends Fragment {
    ...
    private void addColumn() {
        ...
        for (int i = 0; i < addItems; i++) {
            ...
            mItemArray.add(new Pair<>(id, "Task " + id));
        }
        ...
        /*((TextView) header.findViewById(R.id.text)).setText("Task  " + (mColumns + 1));*/

        ((TextView) header.findViewById(R.id.text)).setText("Task todo  ");

        ((TextView) header.findViewById(R.id.item_count)).setText("now working " + addItems);
